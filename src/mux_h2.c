...
static struct task *h2_timeout_task(struct task *t, void *context, unsigned int state);
...
static struct task *h2_deferred_shut(struct task *t, void *ctx, unsigned int state);
