...
static struct task *fcgi_timeout_task(struct task *t, void *context, unsigned int state);
...
static struct task *fcgi_deferred_shut(struct task *t, void *ctx, unsigned int state);
